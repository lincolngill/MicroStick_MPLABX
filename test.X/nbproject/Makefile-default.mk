...
SOURCEFILES_QUOTED_IF_SPACED="../../Documents/pic32/MicroStickII PIC32 Code Example/BlinkLED.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2109814117/BlinkLED.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/2109814117/BlinkLED.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/2109814117/BlinkLED.o

# Source Files
SOURCEFILES=../../Documents/pic32/MicroStickII PIC32 Code Example/BlinkLED.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/2109814117/BlinkLED.o: ../../Documents/pic32/MicroStickII\ PIC32\ Code\ Example/BlinkLED.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2109814117" 
	@${RM} ${OBJECTDIR}/_ext/2109814117/BlinkLED.o.d 
	@${RM} ${OBJECTDIR}/_ext/2109814117/BlinkLED.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2109814117/BlinkLED.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DPKOBSKDEPlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2109814117/BlinkLED.o.d" -o ${OBJECTDIR}/_ext/2109814117/BlinkLED.o "../../Documents/pic32/MicroStickII PIC32 Code Example/BlinkLED.c"    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
