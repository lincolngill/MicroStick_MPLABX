...
#if SYS_FREQ == 64000000
#pragma config FPBDIV = DIV_2           // SYSCLK -64MHz-> FPBDIV (2) -32MHz-> PBCLK
#define PB_FREQ 32000000
#define PB_MHZ 32
#elif SYS_FREQ == 40000000
#pragma config FPBDIV = DIV_1           // SYSCLK -40MHz-> FPBDIV (1) -40MHz-> PBCLK
...
// Set using the Change Notice Pull-down Enable B register (CNPDB)
// Need to make sure we never enable both pull up and pull down registers.
// E.g. EnablePullDownB( BIT_7 | BIT_8 | BIT_9 );
// Port A
